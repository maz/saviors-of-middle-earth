...
class IndexHandler(BaseHandler):
    def get(self):
        self.render_template('items/index.html',recently_added=Item.fresh().order('-creation_time').run(limit=10,projection=('name','price')),about_to_expire=Item.fresh().order('creation_time').run(projection=('name',limit=10))
